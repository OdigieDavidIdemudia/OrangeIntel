...
public class ReportsController : ControllerBase
{
    ...
    [HttpPost("advisory")]
    public async Task<IActionResult> GenerateAdvisoryReport([FromBody] TealHunt.Application.DTOs.Reporting.GTBankAdvisoryReportV1 model, [FromServices] TealHunt.Application.Interfaces.IAdvisoryDocxService advisoryService)
    {
        try
        {
            var userId = GetCurrentUserId();
