...
public class AdvisoryDocxService : IAdvisoryDocxService
{
    ...
    private void BuildCoverPage(MainDocumentPart mainPart, Body body, MetadataV1 metadata)
    {
        ...
        string[] candidates = {
            Path.Combine(currentDir, "backend", "TealHunt.Infrastructure", "Reporting", "Resources", "gtco_logo.png"),
            Path.Combine(currentDir, "TealHunt.Infrastructure", "Reporting", "Resources", "gtco_logo.png"),
            Path.Combine(currentDir, "..", "TealHunt.Infrastructure", "Reporting", "Resources", "gtco_logo.png"),
