...
public class OneTimePasswordService : IOneTimePasswordService
{
    ...
    {
        // otpauth://totp/TealHunt:email?secret=SECRET&issuer=TealHunt&algorithm=SHA1&digits=6&period=30
        return $"otpauth://totp/TealHunt:{email}?secret={secret}&issuer=TealHunt&algorithm=SHA1&digits=6&period=30";
    }
