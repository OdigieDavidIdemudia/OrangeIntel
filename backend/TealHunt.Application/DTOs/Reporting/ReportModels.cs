...
namespace TealHunt.Application.DTOs.Reporting;
...
public class GTBankAdvisoryReportV1
{
    ...
    public string Description { get; set; } = "This is the canonical JSON contract between TealHunt and the AdvisoryDocxService.";
